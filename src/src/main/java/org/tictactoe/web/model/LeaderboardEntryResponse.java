// org.tictactoe.web.model.LeaderboardEntryResponse.java
package org.tictactoe.web.model;

import io.swagger.v3.oas.annotations.media.Schema;
import java.util.UUID;

@Schema(description = "Запись в таблице лидеров")
public class LeaderboardEntryResponse {
    ...
    @Schema(description = "Позиция в таблице лидеров", example = "1")
